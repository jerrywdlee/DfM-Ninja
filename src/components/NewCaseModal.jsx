            ...
            <div className="bg-slate-900 rounded-xl shadow-2xl w-full max-w-2xl border border-slate-700 flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 flex-1 overflow-y-auto">
                    <p className="text-sm text-slate-400 mb-4">
                        Paste the raw JSON data below to create or update a case.
                    </p>
                    <textarea
                        className="w-full h-[400px] bg-slate-950 text-emerald-400 font-mono text-sm p-4 rounded-lg border border-slate-700 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/50"
