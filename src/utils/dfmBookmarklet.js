(function () {
    ...
    // 4. Set up receiver for commands from Ninja
    ...
    const style = 'background: none; border: none; right: 4px; top: 60px; font-size: 18px;';
    const $btn = $(`<button style="${style}" id="Dfm-Ninjia" >🥷</button>`);
    $('body').append($btn);
